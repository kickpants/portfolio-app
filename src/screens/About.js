  ...
  return (
    <Container className="position">
      <Container className="text-box">
        ...
        <Row>
          <Col className="box-text">
            The languages I am comfortable with are HTML, CSS, JavaScript (including
            frameworks like React, or RE’s like Node), React Native, PHP, Python, and C++. In
            terms of other tools, I mostly use SQL and AWS for managing my databases,
            and MATLAB for my computer vision projects.
            <br />
            Recently, I've been interested in deploying containerized applications using 
            docker, and learning the ins and outs of Java.
          </Col>
        </Row>
      </Container>
    </Container>
